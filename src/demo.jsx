...
const CHAPTERS = [
  ...
  },
  {
    ...
    body: 'Browse curated sequences for sleep, focus, fitness. Apply in one tap, then bend them to your reality.',
  ...
  {
    id: 'goals',
    title: 'All your sequences, one place',
